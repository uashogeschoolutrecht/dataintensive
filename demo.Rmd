...
The 3rd edition of the free online book resource for ggplot2:
["ggplot2 Elegant Graphics for Data Analysis"](https://ggplot2-book.org/index.html)
```{r, echo=FALSE}
knitr::include_graphics(path = here::here("images",
                                         "hex-ggplot2.png"))
```
...
## Loading the data package `{dslabs}` and other packages used in this demo
```{r}
library(tidyverse)
library(gganimate)
library(dslabs)
